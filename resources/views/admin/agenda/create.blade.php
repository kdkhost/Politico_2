...
@section('title', 'Novo Evento - ' . config('app.name'))
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header"><h3 class="card-title"><i class="fas fa-calendar-plus me-1"></i>Criar evento</h3></div>
            <form id="eventForm">
                @csrf
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select id="tipo" name="tipo" class="form-select">
                                ...
                                <option value="evento_publico">Evento publico</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="descricao" name="descricao" class="form-control summernote" rows="5"></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="d-flex gap-4">
                        ...
                        <div class="form-check form-switch">
                            <input type="checkbox" id="publicado" name="publicado" class="form-check-input" value="1" checked>
...
<script>
    $(function() {
        $('#eventForm').on('submit', function(e) {
            e.preventDefault();
            $.post('{{ route("admin.agenda.store") }}', $(this).serialize())
                .done(function(res) {
                    if (res.status === 'success') {
                        toastr.success(res.message || 'Evento criado.');
                        window.location.href = '{{ route("admin.agenda.index") }}';
                    } else {
                        toastr.error(res.message || 'Erro ao criar evento.');
                    }
                })
                .fail(function(xhr) {
                    toastr.error(xhr.responseJSON?.message || 'Erro ao criar evento.');
                });
        });
    });
</script>
