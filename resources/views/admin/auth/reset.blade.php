...
<head>
    ...
    @endphp
    <title>Redefinir Senha - {{ $adminSiteName }}</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body.dark .reset-footer a {
            color: #818cf8;
        }

        body.dark .reset-footer a:hover {
            color: #a5b4fc;
        }
...
<body>
    ...
    <div class="reset-wrapper">
        <div class="reset-card">
            ...
            <form method="POST" action="{{ route('admin.reset.submit') }}" id="resetForm" novalidate>
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="password-hint">
                        <i class="fas fa-info-circle me-1"></i>Mínimo de 8 caracteres
                    </div>
                </div>
                ...
                <button type="submit" class="btn-reset" id="resetBtn">
                    ...
                    <div class="spinner-border d-none" id="btnSpinner" role="status">
                        <span class="visually-hidden">Redefinindo...</span>
                    </div>
                </button>
