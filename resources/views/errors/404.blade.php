...
<body>
  <div class="container text-center py-5">
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <i class="fas fa-map-signs text-muted mb-4" style="font-size: 4rem;"></i>
        <div class="error-code">404</div>
        <h1 class="error-title">Página não encontrada</h1>
        <p class="error-text">A página que você procura não existe, foi removida ou o endereço está incorreto. Verifique a URL ou navegue pelo menu.</p>
