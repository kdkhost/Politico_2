...
<head>
  ...
  <title>Erro Interno | {{ config('app.name') }}</title>
  ...
  <div class="container text-center py-5">
    <div class="row justify-content-center">
      <div class="col-lg-6">
        ...
        <p class="error-text">Desculpe, algo deu errado. Nossa equipe já foi notificada e estamos trabalhando para resolver o problema o mais rápido possível.</p>
